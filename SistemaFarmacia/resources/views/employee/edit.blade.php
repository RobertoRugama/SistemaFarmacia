             ...
             <a class="btn btn-primary" href="{{ route('employee.index') }}"> X </a>
                ...
                <div class="panel-body">
                    ...
                    @endif
                        ...
                        <h3 class="page-header">Editar Empleado {{$e->name}}</h3>
                        {!! Form::open(['method'=>'PATCH','route'=>['employee.update']]) !!}
                        {{Form::token()}}
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              ...
                              <div class="form-group col-lg-6 col-md-6">
                                ...
                                <input type="text" name="identification_card" value="{{$e->identification_card}}" class="form-control" placeholder="Cedula del empleado">
                              </div>
                               <div class="form-group col-lg-6 col-md-6">
                                <label for="first_name">Primer Nombre</label>
                                <input type="text" name="first_name" value="{{$e->first_name}}" class="form-control" placeholder="Primer Nombre">
                              </div>
                              <div class="form-group col-lg-6 col-md-6">
                                <label for="second_name">Segundo Nombre</label>
                                <input type="text" name="second_name" value="{{$e->second_name}}" class="form-control" placeholder="Segundo Nombre">
                              </div>
                              <div class="form-group col-lg-6 col-md-6">
                              ...
                              <div class="form-group col-lg-6 col-md-6">
                                ...
                                <input type="text" name="second_last_name" value="{{$e->second_last_name}}" class="form-control" placeholder="Segundo Apellido">
                              </div>
                              <div class="form-group col-lg-6 col-md-6">
                                <label for="address">Direccion</label>
                                <input type="text" name="address" value="{{$e->second_last_name}}" class="form-control" placeholder="Direccion">
                              </div>
                              <div class="form-group col-lg-6 col-md-6">
                                <label for="user">Usuario</label>
                                <input type="text" name="user" value="{{$e->user}}" class="form-control" placeholder="Usuario">
                              </div>
                              <div class="form-group col-lg-6 col-md-6">
